...
public abstract class Move {
    ...
    public int hashCode() {
        ...
        result = prime * this.movePiece.hashCode();
        return result;
    }
    ...
    public boolean equals(final Object other) {
        ...
        return getDesinationCoordinate() == otherMove.getDesinationCoordinate() &&
    ...
    public static final class PawnEnPassantAttackkMove extends PawnAttackMove {

        public PawnEnPassantAttackkMove(final Board board,
                                        final Piece movedPiece,
                                        final int destinationCoordinate, final Piece attackedPiece) {
            super(board, movedPiece, destinationCoordinate, attackedPiece);
        }
